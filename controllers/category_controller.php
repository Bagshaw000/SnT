...
function insert_cat_ctr($cat_name){
    ...
    return $data->insert_cat_cls($cat_name);
}

//SELECT
function select_one_cat_ctr($cat_id){
    $data = new category_class();
    return $data->select_one_cat_cls($cat_id);
}

function select_all_cat_ctr(){
    $data = new category_class();
    return $data->select_all_cat_cls();
}

//UPDATE
function update_cat_ctr($cat_id,$cat_name){
    $data = new category_class();
    return $data->update_cat_cls($cat_id,$cat_name);
}

//DELETE
function delete_cat_cls($cat_id){
    $data = new category_class();
    return $data->delete_cat_cls($cat_id);
}