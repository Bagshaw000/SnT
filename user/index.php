            ...
            <div class="row">
                <div class="col-md-6 banner-left d-flex align-items-center pl-lg-5">
                    <div>
                        ...
                        <a class="btn btn-style-white btn-style-border mt-5" href="about.php">Learn More</a>
                    </div>
                </div>
                    ...
                    <div class="small-images">
                        <div class="ban-grid position-relative">
                            ...
                            <div class="img-ban-sec">
                                <h5>Fast Foods</h5>
                                <a href="menu.php" class="btn p-0">More <i class="fa fa-angle-right ml-1"
        ...
        <div class="container py-md-5 py-4">
            <div class="row">
                <div class="col-lg-6 recipe-left mb-md-0 mb-5">
                    ...
                    <a class="btn btn-style-white btn-style-border mt-5" href="about.php">View More</a>
                </div>
        ...
        <div class="container py-md-5 py-4">
            <div class="row">
                <div class="col-md-7 pr-lg-5">
                    ...
                    <a href="about.php" class="btn btn-style-white btn-style-primary mt-lg-5 mt-4">Learn More</a>
                </div>
            ...
            <div class="container">
                ...
                <div class="row galler-top">
                    <div class="col-md-4 col-sm-6 protfolio-item hover14">
                        <a href="menu.php" data-lightbox="example-set" data-title="Branding Design">
                            <figure>
                    ...
                    <div class="col-md-4 col-sm-6 protfolio-item hover14 mt-sm-0 mt-4">
                        <a href="menu.php" data-lightbox="example-set" data-title="Gradient Website Development">
                            <figure>
                    ...
                    <div class="col-md-4 col-sm-6 protfolio-item hover14 mt-md-0 mt-4">
                        <a href="menu.php" data-lightbox="example-set" data-title="Design and Development">
                            <figure>
                    ...
                    <div class="col-md-4 col-sm-6 protfolio-item hover14 mt-4">
                        <a href="menu.php" data-lightbox="example-set" data-title="Magazine Content Writing">
                            <figure>
                ...
                <div class="text-center">
                    <a href="menu.php" class="btn btn-style-white btn-style-primary mt-lg-5 mt-2">See Our Menu</a>
                </div>
            </div>
        </div>
    </section>
