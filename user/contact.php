...
<head>
    ...
    <title>SnT - Restaurants Category Responsive Website Template - Contact : W3Layouts</title>
    <!-- google-fonts -->
            ...
            <div class="row justify-content-center text-center">
                <div class="col-md-8">
                    <div class="section-heading mb-sm-5 mb-4">
                        ...
                        <p class="lead">
                            Pls this feature is coming soon.
                        </p>
                    </div>
                </div>
            </div>
            <div class="d-grid contact section-gap">
                <div class="contact-info-left d-grid text-center">
                    ...
                    <div class="contact-info">
                        ...
                        <h4>Email</h4>
                        <p><a href="mailto:mail@example.com" class="email">SnT@example.com</a></p>
                        <p><a href="mailto:mail@example1.com" class="email">SnT@example1.com</a></p>
                    </div>
                    <div class="contact-info">
