            ...
            <aside class="sidebar-left">
                <nav class="navbar navbar-inverse">
                    <div class="navbar-header">
                        ...
                        <h1><a class="navbar-brand" href="index.php"><span class="fa fa-area-chart"></span> SnT <span class="dashboard_text">dashboard</span></a></h1>
                    </div>
                ...
                <div class="col_3">
                    <div class="col-md-3 widget widget1">
                        <div class="r3_counter_box">
                            ...
                            <div class="stats">
                                <h5><strong>GHS <?php echo get_total_revenue() ?></strong></h5>
